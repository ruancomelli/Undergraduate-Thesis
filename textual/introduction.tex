...
Além das publicações acadêmicas, existem diversos \textit{softwares} comerciais e de código aberto projetados para simulação com o DEM, cada qual com seus objetivos, vantagens e desvantagens. Os principais simuladores existentes

Os principais simuladores comerciais são o Rocky, o EDEM e o PFD (\textit{Particle Flow Code})

\alert{Citar Rocky, LIGGGHTS e EDEM. Além disso, existem Yade, PFC (Particle Flow Code). E KRATOS}
