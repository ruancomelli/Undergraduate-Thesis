...
Essas etapas podem ser representadas como na figura \ref{fig:simple_dem_algorithm}.
...
\alert{Falar que é possível acoplá-lo com outras famílias de métodos, como CFD, originando o XDEM. Falar que foi Cundall quem começou com isso}

\section{Revisão Bibliográfica}

\subsection{??}

\alert{Falar que a base para o método foi fundada por Newton. Entretanto, devido à dificuldade de se resolverem problemas tão simples quanto o de três corpos, isso ficou quase que estacionado até que }
\alert{Falar que Cundall começou isso. Falar que, no início, aceleração, velocidade etc. eram consideradas constantes para a estimativa dos carregamentos.}
