...
Assim, o \nameref{theo:taylor} permite a estimativa do valor de uma função em um ponto \(t+\Delta t\) a partir do valor da função e de suas derivadas em um ponto \(t\), e essa estimativa é tanto melhor quanto menor for o valor de \(\Delta t\).
...
Com isso, é possível escrever \alert{Mostrar a forma matricial}
...
A predição é feita através de extrapolações conforme a seção \ref{sec:extrapolation}.
