...
\begin{equation*}
	\rho \eqdef \dfrac{4\cdot\effectiveNormalElasticij}{3}\cdot\dfrac{\sqrt{\effectiveRadiusij}}{\pqty{\massi^{-1} + \massj^{-1}}^{-1}}.
\end{equation*}
...
\alert{Escrever}
\subsubsection*{Modelo 1}\alert{Escrever}
\subsubsection*{Modelo 2}\alert{Escrever}
