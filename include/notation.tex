...
\newcommand{\eqForExplicit}[1]{f_{\text{impl}}^{#1}}
\newcommand{\eqForImplicit}[1]{f_{\text{expl}}^{#1}}

\newcommand{\extrapolationMatrixSymbol}{\mtx{A}}
\newcommand{\extrapolationMatrix}[1]{\extrapolationMatrixSymbol_{#1}}

\newcommand{\correctorConstantSymbol}{c}
\newcommand{\correctorConstant}[1]{\correctorConstantSymbol_{#1}}
\newcommand{\correctorConstantVectorSymbol}{\vec{\correctorConstantSymbol}}
\newcommand{\correctorConstantVector}[1]{\correctorConstantVectorSymbol_{#1}}
